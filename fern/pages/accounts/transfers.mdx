...
<img src="../../assets/Screenshot 2024-07-15 at 4.06.49 PM.png" alt="" width="521"/>
</Frame>
<Frame caption="Transfer your USDC to a different Paradex L2 Address">
<img src="../../assets/Screenshot 2024-07-15 at 4.07.11 PM (1).png" alt="" width="290"/>
</Frame>
## Via API

Should for any reason you need to transfer funds from your current Paradex Wallet to a different Paradex Wallet via API, you are also able to leverage Starknet APIs do this. Feel free to use [this script](https://github.com/paradextrade/code-samples/blob/main/python/transfer_l2_usdc.py) to do so or as a reference should you want to build your own.
