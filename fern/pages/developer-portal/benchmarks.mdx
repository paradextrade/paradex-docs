...
* [Benchmarking code for Go, Java, Python, TypeScript](https://github.com/paradextrade/code-samples)
* [Rust implementation](https://github.com/xJonathanLEI/starknet-rs/blob/master/starknet-crypto/benches/ecdsa_sign.rs)
* [C++ implementation](https://github.com/paradextrade/starknet-signing-cpp)
